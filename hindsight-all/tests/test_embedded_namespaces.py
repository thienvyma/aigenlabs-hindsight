...
def test_embedded_accepts_codex_home_without_starting_daemon():
    """Codex OAuth isolation config should be accepted at construction time."""
    client = HindsightEmbedded(
        profile="test",
        llm_provider="openai-codex",
        llm_model="gpt-4o-mini",
        codex_home="/tmp/aigenlabs-business-os-codex",
    )

    assert client.config["CODEX_HOME"] == "/tmp/aigenlabs-business-os-codex"
